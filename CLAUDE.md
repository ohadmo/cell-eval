...
- **DE metrics** (`_de.py`, `_gsea_nes.py`, `_progeny.py`): overlap/precision at N, spearman correlations, direction match, significant gene recall, ROC/PR AUC, optional pathway-level GSEA NES Spearman and PROGENy activity Spearman
